...
func (c *authorizationClient) Validate(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*ValidateResponse, error) {
	out := new(ValidateResponse)
	err := c.cc.Invoke(ctx, "/message.Authorization/Validate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthorizationServer) Validate(context.Context, *ValidateRequest) (*ValidateResponse, error) {
...
func _Authorization_Validate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.Authorization/Validate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizationServer).Validate(ctx, req.(*ValidateRequest))
	}
...
var Authorization_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "message.Authorization",
	...
	Metadata: "pkg/proto/message/authorization.proto",
}
